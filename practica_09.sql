...
IF (MY_PORCIENTO_COMPLETADA+PORCIENTO_COMPLETADA) > 100 THEN
...
END IF;
UPDATE TAREA SET PORCIENTO_COMPLETADA=(MY_PORCIENTO_COMPLETADA+PORCENTAJE_ACTUAL), FECHA=SYSDATE WHERE ID_TAREA=MY_ID_TAREA;
END;
